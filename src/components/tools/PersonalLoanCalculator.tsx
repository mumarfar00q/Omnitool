...
import { Calculator, Info, RotateCcw, BadgeDollarSign } from 'lucide-react';
    ...
    <div className="grid grid-cols-12 gap-4 md:gap-6 animate-in fade-in duration-500">
      ...
      <div className="col-span-12 lg:col-span-7 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6 flex flex-col shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-4 pt-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[9px] font-bold text-[var(--text-secondary)] opacity-60 uppercase">Capital</span>
            </div>
            <div className="flex items-center gap-1.5">
        ...
        <div className="mt-auto pt-4 border-t border-[var(--border-color)]">
          <p className="text-[9px] text-[var(--text-secondary)] leading-relaxed font-bold uppercase opacity-40">
            Financial Tip: Extra monthly payments can reduce your term significantly.
          </p>
        </div>
      </div>
    </div>
